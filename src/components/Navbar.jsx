...
const Navbar = ({ activeProp }) => {
  ...
  return (
    <div className="w-full flex items-center justify-between md:px-[4rem] pt-[2rem] px-[0.5rem]">
      ...
      <div className="fixed z-[100] left-[50%] translate-x-[-50%] rounded-full bg-[#232323] py-[1rem] px-[1rem] flex justify-between gilroy text-[0.85rem] max-md:scale-[60%]">
